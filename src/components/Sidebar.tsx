  ...
  return (
    <>
      <div className={`
        ...
        bg-vscode-sidebar border-r border-vscode-border flex flex-col h-full
        ...
        <div className="p-4 border-b border-vscode-border">
          <div className="flex items-center justify-between mb-4">
            ...
            {!isMobile && (
              <button
                onClick={onToggleCollapse}
                className="p-1 text-vscode-text/70 hover:text-vscode-text hover:bg-vscode-active rounded transition-colors touch-target"
