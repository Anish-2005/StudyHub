...
const ShareModal: React.FC<ShareModalProps> = ({ topic, username, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-end justify-center bg-black/65 p-2 motion-fade-up sm:items-center sm:p-6">
      <div className="surface motion-scale-in w-full max-w-lg">
